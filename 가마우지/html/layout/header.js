...
<div class="header">
    <div class="headerTop">
        <div class="headerTopBox">
            <div class="logo">
                <img src="../../image/logo-airbnb.svg" alt="">
            </div>
            <div class="search">
                <ul>
                    <li>어디든지</li>
                    ...
                    <li></li>
                    <li>게스트 추가</li>
                    <li class="searchIcon"><img src="../../image/icon-search.svg" alt=""></li>
                </ul>
            </div>
            <div class="loginMenu">
                <div class="host">호스트 되기</div>
                <div class="lang"><img src="../../image/icon-global.svg" alt=""></div>
                <div class="login">
                    <button><img class="icon-menu" src="../../image/icon-menu.svg" alt=""><img class="icon-person" src="../../image/icon-person.svg" alt=""></button>
                </div>
            </div>
        </div>
    </div>
